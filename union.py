...
class union:
    def consulta1():
        ...
        def c1():
            root.destroy()
            from consulta1 import Consultas
            Consultas.consulta1() 
        def regresar():
            root.destroy()
    ...
    def consulta6():
        ...
        lbc6 = Label(root, text="Consulta 6: Deseo saber cuantas casas en la ciudad de Citrus Heights de tipo Condo, con un precio\n"
                "menor a $100000 hay.")
        lbc6.pack()
    ...
    def consulta7():
        ...
        lbc7 = Label(root, text="Consulta 7: Deseo saber cuantas casas en la ciudad de Antelope con un precio entre $100000 y $200000\n"
